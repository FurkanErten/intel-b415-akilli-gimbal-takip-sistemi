...
def parse_args():
    ...
    p.add_argument("--yolo", type=str, default="modeller/yuz_tespit_yolov11l.pt", help="YOLO face model path. Archive içinde varsayılan: modeller/yuz_tespit_yolov11l.pt")
