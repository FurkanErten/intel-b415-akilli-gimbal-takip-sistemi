"""
DeepFusionNet model definition and loader utilities.

Bu dosyadaki mimari, model.pth içindeki state_dict anahtarlarıyla uyumlu olacak
şekilde korunmuştur. Katman isimlerini değiştirme; aksi halde load_state_dict
uyuşmazlığı oluşabilir.
"""
...
class DeepFusionNet(nn.Module):
    ...
    def __init__(self):
        ...
        # forward içinde kullanılmıyorlar ama model.pth içinde ağırlıkları var.
...
def load_deepfusion_model(
    ...
    """DeepFusionNet modelini model.pth ağırlıklarıyla yükler."""
